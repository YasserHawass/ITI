...
//import java.util.strea.Collectors.toList;
...
*/
		...
		//List<City> cities = worldDao.findAllCities().stream().toArray();
		//List<City> hCities = cities.stream().forEach(System.out::println);
		//hCities.forEach((ci) -> System.out.println(ci));
		List<Country> countries = worldDao.findAllCountries();
		List<City> cities = worldDao.findAllCities();
		//List<Integer> lab1 = cities.stream().map(ci -> ci.getName().ci.getPopulation()}).collect(Collectors.toList());
		//List<String,Integer> lab1 = cities.stream().flatMap(ci -> Stream.of(ci).forEach()).collect(Collectors.toList());
		
		do{
/*
			cities.stream()
			.forEach(ci -> System.out.println(ci.getName() + ": "+ci.getPopulation()));
*/
/*
			countries.stream()
			.forEach(ci -> ci.getCities().stream().
*/
/*

			allContinents.values().stream()
			.map(c->c.getCities().stream()
			...
			.forEach(c -> {
				if(c.isPresent())
					System.out.println( c.get().getName() + ": "+ c.get().getPopulation());
			}  );
*/
...
/*
		...
		Set<Map.Entry<Integer, City>>  citiesx = worldDao.getCities().entrySet();
		...
		Map<String, Country> allCountriesx=worldDao.getCountries();
		// allCountriesx.get(x.getValue().getCountryCode()).getContinent()
		Map<String, List<City>>  groups = citiesx.stream().map(x -> x.getValue() ).collect(Collectors.groupingBy( x -> allCountriesx.get(x.getCountryCode()).getContinent() ));	
		...
		} ).forEach(( x ) ->  System.out.println(x.getKey() + ": " + x.getValue().getName()) );

*/
// PLEASE LET ME GO

		Set<Map.Entry<String, Country>>  worldx = worldDao.getCountries().entrySet();
		Set<Map.Entry<Integer, City>>  citiesx = worldDao.getCities().entrySet();
		Map<String, Country> allCountriesx=worldDao.getCountries();
		Map<Integer, City> allCitiesx=worldDao.getCities();
		
		var best = worldx.stream().map( x -> allCitiesx.get(x.getValue().getCapital()) )
								.filter( x -> x!=null)
		...
		System.out.println(best.getName());
			...
			//countries.forEach((ci) -> System.out.println(ci.getName()));
			//cities.forEach(ci -> System.out.println(ci.getPopulation()));
			//lab1.forEach(x -> System.out.println(x));
/*
			countries.stream()
			.flatMap(citiesList -> Stream.of(citiesList.getCities())
			.map(city -> System.out.println(city.getName()))
			);

			countries.stream()
			.map(list -> System.out.println(list.getCities()));
			//.map(city -> System.out.println(city.getName()));
			//.map(city -> System.out.println(city.getName()));
...
/*
			cities.stream()
			.flatMap(ci -> Stream.of(ci).forEach(x -> System.out.println(x)))
			;
*/
			//cities.stream().map(ci -> ci.getPopulation()).collect(Collectors.toList()).forEach(x -> System.out.println(x));
			// okay cities.stream().collect(Collectors.toList()).forEach(ci -> System.out.println(ci.getName() + ": "+ci.getPopulation() ));
		}while(false);
...
*/		
	...
	public void createCities1() {
		...
		cities.put(20, new City(20, "ïs-Hertogenbosch", "NLD", 129170));
		...
		cities.put(40, new City(40, "S‚tif", "DZA", 179055));
		cities.put(41, new City(41, "Sidi Bel AbbŠs", "DZA", 153106));
		...
		cities.put(63, new City(63, "Saint Johnïs", "ATG", 24000));
		...
		cities.put(71, new City(71, "C¢rdoba", "ARG", 1157507));
		...
		cities.put(78, new City(78, "San Miguel de Tucum n", "ARG", 470809));
		cities.put(79, new City(79, "Lan£s", "ARG", 469735));
		cities.put(80, new City(80, "Merlo", "ARG", 463846));
		cities.put(81, new City(81, "General San Mart¡n", "ARG", 422542));
		cities.put(82, new City(82, "Salta", "ARG", 367550));
		cities.put(83, new City(83, "Moreno", "ARG", 356993));
		cities.put(84, new City(84, "Santa F‚", "ARG", 353063));
		cities.put(85, new City(85, "Avellaneda", "ARG", 353046));
		cities.put(86, new City(86, "Tres de Febrero", "ARG", 352311));
		cities.put(87, new City(87, "Mor¢n", "ARG", 349246));
		...
		cities.put(92, new City(92, "Vicente L¢pez", "ARG", 288341));
		...
		cities.put(96, new City(96, "Bah¡a Blanca", "ARG", 239810));
		cities.put(97, new City(97, "Esteban Echeverr¡a", "ARG", 235760));
		cities.put(98, new City(98, "Resistencia", "ARG", 229212));
		cities.put(99, new City(99, "Jos‚ C. Paz", "ARG", 221754));
		cities.put(100, new City(100, "Paran ", "ARG", 207041));
		cities.put(101, new City(101, "Godoy Cruz", "ARG", 206998));
		cities.put(102, new City(102, "Posadas", "ARG", 201273));
		cities.put(103, new City(103, "Guaymall‚n", "ARG", 200595));
		...
		cities.put(107, new City(107, "Neuqu‚n", "ARG", 167296));
		cities.put(108, new City(108, "Ituzaing¢", "ARG", 158197));
		...
		cities.put(113, new City(113, "San Fernando del Valle de Cata", "ARG",
				134935));
		cities.put(114, new City(114, "R¡o Cuarto", "ARG", 134355));
		cities.put(115, new City(115, "Comodoro Rivadavia", "ARG", 124104));
		cities.put(116, new City(116, "Mendoza", "ARG", 123027));
		cities.put(117, new City(117, "San Nicol s de los Arroyos", "ARG",
				119302));
		...
		cities.put(145, new City(145, "G„nc„", "AZE", 299300));
		cities.put(146, new City(146, "Sumqayit", "AZE", 283000));
		cities.put(147, new City(147, "Ming„‡evir", "AZE", 93900));
		...
		cities.put(178, new City(178, "LiŠge", "BEL", 185639));
		...
		cities.put(199, new City(199, "Potos¡", "BOL", 140642));
		...
		cities.put(206, new City(206, "SÆo Paulo", "BRA", 9968485));
		...
		cities.put(211, new City(211, "Bras¡lia", "BRA", 1969868));
		...
		cities.put(216, new City(216, "Bel‚m", "BRA", 1186926));
		cities.put(217, new City(217, "Guarulhos", "BRA", 1095874));
		cities.put(218, new City(218, "Goiƒnia", "BRA", 1056330));
		cities.put(219, new City(219, "Campinas", "BRA", 950043));
		cities.put(220, new City(220, "SÆo Gon‡alo", "BRA", 869254));
		cities.put(221, new City(221, "Nova Igua‡u", "BRA", 862225));
		cities.put(222, new City(222, "SÆo Lu¡s", "BRA", 837588));
		cities.put(223, new City(223, "Macei¢", "BRA", 786288));
		cities.put(224, new City(224, "Duque de Caxias", "BRA", 746758));
		cities.put(225, new City(225, "SÆo Bernardo do Campo", "BRA",
				723132));
		...
		cities.put(230, new City(230, "Santo Andr‚", "BRA", 630073));
		cities.put(231, new City(231, "JoÆo Pessoa", "BRA", 584029));
		cities.put(232, new City(232, "JaboatÆo dos Guararapes", "BRA",
				558680));
		cities.put(233, new City(233, "Contagem", "BRA", 520801));
		cities.put(234, new City(234, "SÆo Jos‚ dos Campos", "BRA",
				515553));
		cities.put(235, new City(235, "Uberlƒndia", "BRA", 487222));
		cities.put(236, new City(236, "Feira de Santana", "BRA", 479992));
		cities.put(237, new City(237, "RibeirÆo Preto", "BRA", 473276));
		cities.put(238, new City(238, "Sorocaba", "BRA", 466823));
		cities.put(239, new City(239, "Niter¢i", "BRA", 459884));
		cities.put(240, new City(240, "Cuiab ", "BRA", 453813));
		cities.put(241, new City(241, "Juiz de Fora", "BRA", 450288));
		cities.put(242, new City(242, "Aracaju", "BRA", 445555));
		cities.put(243, new City(243, "SÆo JoÆo de Meriti", "BRA",
				440052));
		...
		cities.put(250, new City(250, "Mau ", "BRA", 375055));
		cities.put(251, new City(251, "Carapicu¡ba", "BRA", 357552));
		cities.put(252, new City(252, "Olinda", "BRA", 354732));
		cities.put(253, new City(253, "Campina Grande", "BRA", 352497));
		cities.put(254, new City(254, "SÆo Jos‚ do Rio Preto", "BRA",
				351944));
		...
		cities.put(258,
				new City(258, "Aparecida de Goiƒnia", "BRA", 324662));
		...
		cities.put(267, new City(267, "Jund¡a¡", "BRA", 296127));
		cities.put(268, new City(268, "Canoas", "BRA", 294125));
		cities.put(269, new City(269, "Franca", "BRA", 290139));
		cities.put(270, new City(270, "SÆo Vicente", "BRA", 286848));
		cities.put(271, new City(271, "Maring ", "BRA", 286461));
		cities.put(272, new City(272, "Montes Claros", "BRA", 286058));
		cities.put(273, new City(273, "An polis", "BRA", 282197));
		cities.put(274, new City(274, "Florian¢polis", "BRA", 281928));
		cities.put(275, new City(275, "Petr¢polis", "BRA", 279183));
		cities.put(276, new City(276, "Itaquaquecetuba", "BRA", 270874));
		cities.put(277, new City(277, "Vit¢ria", "BRA", 270626));
		cities.put(278, new City(278, "Ponta Grossa", "BRA", 268013));
		cities.put(279, new City(279, "Rio Branco", "BRA", 259537));
		cities.put(280, new City(280, "Foz do Igua‡u", "BRA", 259425));
		cities.put(281, new City(281, "Macap ", "BRA", 256033));
		cities.put(282, new City(282, "Ilh‚us", "BRA", 254970));
		cities.put(283, new City(283, "Vit¢ria da Conquista", "BRA", 253587));
		...
		cities.put(289, new City(289, "Santar‚m", "BRA", 241771));
		...
		cities.put(295, new City(295, "Guaruj ", "BRA", 237206));
		cities.put(296, new City(296, "RibeirÆo das Neves", "BRA", 232685));
		cities.put(297, new City(297, "Governador Valadares", "BRA", 231724));
		cities.put(298, new City(298, "Taubat‚", "BRA", 229130));
		cities.put(299, new City(299, "Imperatriz", "BRA", 224564));
		cities.put(300, new City(300, "Gravata¡", "BRA", 223011));
		cities.put(301, new City(301, "Embu", "BRA", 222223));
		cities.put(302, new City(302, "Mossor¢", "BRA", 214901));
		cities.put(303, new City(303, "V rzea Grande", "BRA", 214435));
		cities.put(304, new City(304, "Petrolina", "BRA", 210540));
		cities.put(305, new City(305, "Barueri", "BRA", 208426));
		cities.put(306, new City(306, "ViamÆo", "BRA", 207557));
		...
		cities.put(310, new City(310, "TaboÆo da Serra", "BRA", 197550));
		cities.put(311, new City(311, "SÆo Jos‚ dos Pinhais", "BRA",
				196884));
		cities.put(312, new City(312, "Mag‚", "BRA", 196147));
		cities.put(313, new City(313, "Suzano", "BRA", 195434));
		cities.put(314, new City(314, "SÆo Leopoldo", "BRA", 189258));
		cities.put(315, new City(315, "Mar¡lia", "BRA", 188691));
		cities.put(316, new City(316, "SÆo Carlos", "BRA", 187122));
		cities.put(317, new City(317, "Sumar‚", "BRA", 186205));
		cities.put(318, new City(318, "Presidente Prudente", "BRA", 185340));
		cities.put(319, new City(319, "Divin¢polis", "BRA", 185047));
		...
		cities.put(323, new City(323, "Jequi‚", "BRA", 179128));
		...
		cities.put(329, new City(329, "Itabora¡", "BRA", 173977));
		cities.put(330, new City(330, "Santa B rbara dïOeste", "BRA",
				171657));
		cities.put(331, new City(331, "Nova Friburgo", "BRA", 170697));
		cities.put(332, new City(332, "Jacare¡", "BRA", 170356));
		cities.put(333, new City(333, "Ara‡atuba", "BRA", 169303));
		cities.put(334, new City(334, "Barra Mansa", "BRA", 168953));
		cities.put(335, new City(335, "Praia Grande", "BRA", 168434));
		cities.put(336, new City(336, "Marab ", "BRA", 167795));
		cities.put(337, new City(337, "Crici£ma", "BRA", 167661));
		...
		cities.put(343, new City(343, "Maracana£", "BRA", 162022));
		cities.put(344, new City(344, "Guarapuava", "BRA", 160510));
		cities.put(345, new City(345, "Rondon¢polis", "BRA", 155115));
		cities.put(346, new City(346, "SÆo Jos‚", "BRA", 155105));
		cities.put(347, new City(347, "Cachoeiro de Itapemirim", "BRA", 155024));
		cities.put(348, new City(348, "Nil¢polis", "BRA", 153383));
		cities.put(349, new City(349, "Itapevi", "BRA", 150664));
		cities.put(350, new City(350, "Cabo de Santo Agostinho", "BRA", 149964));
		cities.put(351, new City(351, "Cama‡ari", "BRA", 149146));
		cities.put(352, new City(352, "Sobral", "BRA", 146005));
		cities.put(353, new City(353, "Itaja¡", "BRA", 145197));
		cities.put(354, new City(354, "Chapec¢", "BRA", 144158));
		...
		cities.put(359, new City(359, "Hortolƒndia", "BRA", 135755));
		cities.put(360, new City(360, "Caxias", "BRA", 133980));
		cities.put(361, new City(361, "SÆo Caetano do Sul", "BRA", 133321));
		cities.put(362, new City(362, "Itu", "BRA", 132736));
		cities.put(363,
				new City(363, "Nossa Senhora do Socorro", "BRA", 131351));
		cities.put(364, new City(364, "Parna¡ba", "BRA", 129756));
		cities.put(365, new City(365, "Po‡os de Caldas", "BRA", 129683));
		cities.put(366, new City(366, "Teres¢polis", "BRA", 128079));
		...
		cities.put(372, new City(372, "Paranagu ", "BRA", 126076));
		cities.put(373, new City(373, "Ibirit‚", "BRA", 125982));
		cities.put(374, new City(374, "Timon", "BRA", 125812));
		cities.put(375, new City(375, "Luziƒnia", "BRA", 125597));
		cities.put(376, new City(376, "Maca‚", "BRA", 125597));
		cities.put(377, new City(377, "Te¢filo Otoni", "BRA", 124489));
		cities.put(378, new City(378, "Moji-Gua‡u", "BRA", 123782));
		...
		cities.put(382, new City(382, "Bag‚", "BRA", 120793));
		...
		cities.put(388, new City(388, "Bragan‡a Paulista", "BRA", 116929));
		cities.put(389, new City(389, "Queimados", "BRA", 115020));
		cities.put(390, new City(390, "Aragua¡na", "BRA", 114948));
		cities.put(391, new City(391, "Garanhuns", "BRA", 114603));
		cities.put(392, new City(392, "Vit¢ria de Santo AntÆo", "BRA",
				113595));
		...
		cities.put(396, new City(396, "Ja£", "BRA", 109965));
		...
		cities.put(401, new City(401, "RibeirÆo Pires", "BRA", 108121));
		cities.put(402, new City(402, "Sabar ", "BRA", 107781));
		...
		cities.put(411, new City(411, "Guaratinguet ", "BRA", 103433));
		cities.put(412, new City(412, "Cachoeirinha", "BRA", 103240));
		cities.put(413, new City(413, "Cod¢", "BRA", 103153));
		cities.put(414, new City(414, "Jaragu  do Sul", "BRA", 102580));
		cities.put(415, new City(415, "CubatÆo", "BRA", 102372));
		...
		cities.put(426, new City(426, "SÆo Jos‚ de Ribamar", "BRA",
				98318));
		cities.put(427, new City(427, "Pinhais", "BRA", 98198));
		cities.put(428, new City(428, "SertÆozinho", "BRA", 98140));
		...
		cities.put(432, new City(432, "Eun polis", "BRA", 96610));
		...
		cities.put(439, new City(439, "Tatu¡", "BRA", 93897));
		cities.put(440, new City(440, "Ji-Paran ", "BRA", 93346));
		cities.put(441, new City(441, "Bacabal", "BRA", 93121));
		cities.put(442, new City(442, "Camet ", "BRA", 92779));
		cities.put(443, new City(443, "Gua¡ba", "BRA", 92224));
		cities.put(444, new City(444, "SÆo Louren‡o da Mata", "BRA",
				91999));
		...
		cities.put(450, new City(450, "Corumb ", "BRA", 90111));
		cities.put(451, new City(451, "Palho‡a", "BRA", 89465));
		cities.put(452, new City(452, "Barra do Pira¡", "BRA", 89388));
		cities.put(453, new City(453, "Bento Gon‡alves", "BRA", 89254));
		cities.put(454, new City(454, "Po ", "BRA", 89236));
		cities.put(455, new City(455, "µguas Lindas de Goi s", "BRA",
				89200));
		...
		cities.put(556, new City(556, "Vi¤a del Mar", "CHL", 312493));
		cities.put(557, new City(557, "Valpara¡so", "CHL", 293800));
		...
		cities.put(562, new City(562, "Concepci¢n", "CHL", 217664));
		...
		cities.put(566, new City(566, "Chill n", "CHL", 178182));
		...
		cities.put(576, new City(576, "Copiap¢", "CHL", 120128));
		cities.put(577, new City(577, "Quilpu‚", "CHL", 118857));
		cities.put(578, new City(578, "Curic¢", "CHL", 115766));
		...
		cities.put(584, new City(584, "San Jos‚", "CRI", 339131));
		cities.put(585, new City(585, "Djibouti", "DJI", 383000));
		cities.put(586, new City(586, "Roseau", "DMA", 16243));
		cities.put(587, new City(587, "Santo Domingo de Guzm n", "DOM",
				1609966));
		cities.put(588, new City(588, "Santiago de los Caballeros", "DOM",
				365463));
		cities.put(589, new City(589, "La Romana", "DOM", 140204));
		cities.put(590, new City(590, "San Pedro de Macor¡s", "DOM", 124735));
		cities.put(591, new City(591, "San Francisco de Macor¡s", "DOM",
				108485));
		...
		cities.put(606, new City(606, "R¡obamba", "ECU", 123163));
		...
		cities.put(658, new City(658, "M laga", "ESP", 530553));
		...
		cities.put(664, new City(664, "C¢rdoba", "ESP", 311708));
		cities.put(665, new City(665, "Vigo", "ESP", 283670));
		cities.put(666, new City(666, "Alicante [Alacant]", "ESP", 272432));
		cities.put(667, new City(667, "Gij¢n", "ESP", 267980));
		cities.put(668, new City(668, "LïHospitalet de Llobregat", "ESP",
				247986));
		cities.put(669, new City(669, "Granada", "ESP", 244767));
		cities.put(670, new City(670, "A Coru¤a (La Coru¤a)", "ESP",
				243402));
		...
		cities.put(675, new City(675, "M¢stoles", "ESP", 195351));
		...
		cities.put(680, new City(680, "Pamplona [Iru¤a]", "ESP", 180483));
		cities.put(681, new City(681, "Donostia-San Sebasti n", "ESP",
				179208));
		cities.put(682, new City(682, "Cartagena", "ESP", 177709));
		cities.put(683, new City(683, "Legan‚s", "ESP", 173163));
		cities.put(684, new City(684, "Fuenlabrada", "ESP", 171173));
		cities.put(685, new City(685, "Almer¡a", "ESP", 169027));
		cities.put(686, new City(686, "Terrassa", "ESP", 168695));
		cities.put(687, new City(687, "Alcal  de Henares", "ESP", 164463));
		...
		cities.put(692, new City(692, "C diz", "ESP", 142449));
		cities.put(693, new City(693, "Alcorc¢n", "ESP", 142048));
		cities.put(694, new City(694, "Huelva", "ESP", 140583));
		cities.put(695, new City(695, "Le¢n", "ESP", 139809));
		cities.put(696, new City(696, "Castell¢n de la Plana [Castell",
				"ESP", 139712));
		cities.put(697, new City(697, "Badajoz", "ESP", 136613));
		cities.put(698, new City(698, "[San Crist¢bal de] la Laguna", "ESP",
				127945));
		cities.put(699, new City(699, "Logro¤o", "ESP", 127093));
		cities.put(700,
				new City(700, "Santa Coloma de Gramenet", "ESP", 120802));
		cities.put(701, new City(701, "Tarragona", "ESP", 113016));
		cities.put(702, new City(702, "Lleida (L‚rida)", "ESP", 112207));
		cities.put(703, new City(703, "Ja‚n", "ESP", 109247));
		cities.put(704, new City(704, "Ourense (Orense)", "ESP", 109120));
		cities.put(705, new City(705, "Matar¢", "ESP", 104095));
		...
		cities.put(711, new City(711, "Torrej¢n de Ardoz", "ESP", 92262));
		...
		cities.put(773, new City(773, "Las Pi¤as", "PHL", 472780));
		...
		cities.put(777, new City(777, "Para¤aque", "PHL", 449811));
		...
		cities.put(782, new City(782, "Dasmari¤as", "PHL", 379520));
		...
		cities.put(787,
				new City(787, "San Jos‚ del Monte", "PHL", 315807));
		...
		cities.put(806, new City(806, "Bi¤an", "PHL", 201186));
		...
		cities.put(901, new City(901, "T¢rshavn", "FRO", 14542));
		...
		cities.put(916, new City(916, "Saint Georgeïs", "GRD", 4621));
		...
		cities.put(921, new City(921, "Aga¤a", "GUM", 1139));
		...
		cities.put(932, new City(932, "Le-Cap-Ha‹tien", "HTI", 102233));
	...
	public void createCities1000() {
		...
		cities.put(1449, new City(1449, "Reykjav¡k", "ISL", 109184));
		...
		cities.put(1489,
				new City(1489, "Reggio nellï Emilia", "ITA", 143664));
		...
		cities.put(1502, new City(1502, "Forl�?", "ITA", 107475));
		...
		cities.put(1804, new City(1804, "Yaound‚", "CMR", 1372800));
		...
		cities.put(1810, new City(1810, "Montr‚al", "CAN", 1016376));
		...
		cities.put(1832, new City(1832, "Qu‚bec", "CAN", 167264));
		...
		cities.put(1851, new City(1851, "Saint Johnïs", "CAN", 101936));
		...
		cities.put(1877, new City(1877, "K�?kshetau", "KAZ", 123400));
		...
		cities.put(1901, new City(1901, "Xiïan", "CHN", 2761400));
		...
		cities.put(1917, new City(1917, "Urumt?i [šr�?mqi]", "CHN",
				1310100));
		...
		cities.put(1991, new City(1991, "Taiïan", "CHN", 350696));
	...
	public void createCities2000() {
		...
		cities.put(2005, new City(2005, "Maïanshan", "CHN", 305421));
		...
		cities.put(2065, new City(2065, "Beiïan", "CHN", 204899));
		...
		cities.put(2128, new City(2128, "Ruiïan", "CHN", 156468));
		...
		cities.put(2137, new City(2137, "Jiïan", "CHN", 148583));
		...
		cities.put(2144, new City(2144, "Liuïan", "CHN", 144248));
		...
		cities.put(2171, new City(2171, "Huaiïan", "CHN", 131149));
		...
		cities.put(2202, new City(2202, "Yanïan", "CHN", 113277));
		...
		cities.put(2206, new City(2206, "Yongïan", "CHN", 111762));
		...
		cities.put(2218, new City(2218, "Fuïan", "CHN", 105265));
		...
		cities.put(2237, new City(2237, "Yaïan", "CHN", 95900));
		...
		cities.put(2276, new City(2276, "Monter¡a", "COL", 248245));
		cities.put(2277, new City(2277, "Itag�?¡", "COL", 228985));
		...
		cities.put(2415, new City(2415, "Camag�?ey", "CUB", 298726));
		cities.put(2416, new City(2416, "Holgu¡n", "CUB", 249492));
		cities.put(2417, new City(2417, "Santa Clara", "CUB", 207350));
		cities.put(2418, new City(2418, "Guant namo", "CUB", 205078));
		cities.put(2419, new City(2419, "Pinar del R¡o", "CUB", 142100));
		...
		cities.put(2425, new City(2425, "Sancti-Sp¡ritus", "CUB", 100751));
		cities.put(2426, new City(2426, "Ciego de µvila", "CUB", 98505));
		...
		cities.put(2452, new City(2452,
				"Luxembourg [Luxemburg/L‰tzebuerg]", "LUX", 80700));
		cities.put(2453, new City(2453, "El-Aai£n", "ESH", 169000));
		...
		cities.put(2457, new City(2457, "Antsirab‚", "MDG", 120239));
		...
		cities.put(2488, new City(2488, "FŠs", "MAR", 541162));
		cities.put(2489, new City(2489, "Tanger", "MAR", 521735));
		cities.put(2490, new City(2490, "Sal‚", "MAR", 504420));
		cities.put(2491, new City(2491, "MeknŠs", "MAR", 460000));
		cities.put(2492, new City(2492, "Oujda", "MAR", 365382));
		cities.put(2493, new City(2493, "K‚nitra", "MAR", 292600));
		cities.put(2494, new City(2494, "T‚touan", "MAR", 277516));
	...
	public void createCities2500() {
		cities.put(2500, new City(2500, "T‚mara", "MAR", 126303));
		...
		cities.put(2510, new City(2510, "Nouƒdhibou", "MRT", 97600));
		...
		cities.put(2515, new City(2515, "Ciudad de M‚xico", "MEX",
				8591309));
		...
		cities.put(2519, new City(2519, "Nezahualc¢yotl", "MEX", 1224924));
		cities.put(2520, new City(2520, "Ju rez", "MEX", 1217818));
		cities.put(2521, new City(2521, "Tijuana", "MEX", 1212232));
		cities.put(2522, new City(2522, "Le¢n", "MEX", 1133576));
		cities.put(2523, new City(2523, "Monterrey", "MEX", 1108499));
		cities.put(2524, new City(2524, "Zapopan", "MEX", 1002239));
		cities.put(2525,
				new City(2525, "Naucalpan de Ju rez", "MEX", 857511));
		cities.put(2526, new City(2526, "Mexicali", "MEX", 764902));
		cities.put(2527, new City(2527, "Culiac n", "MEX", 744859));
		cities.put(2528, new City(2528, "Acapulco de Ju rez", "MEX", 721011));
		cities.put(2529, new City(2529, "Tlalnepantla de Baz", "MEX", 720755));
		cities.put(2530, new City(2530, "M‚rida", "MEX", 703324));
		cities.put(2531, new City(2531, "Chihuahua", "MEX", 670208));
		cities.put(2532, new City(2532, "San Luis Potos¡", "MEX", 669353));
		...
		cities.put(2536, new City(2536, "Quer‚taro", "MEX", 639839));
		...
		cities.put(2540, new City(2540, "Torre¢n", "MEX", 529093));
		cities.put(2541, new City(2541, "Centro (Villahermosa)", "MEX", 519873));
		cities.put(2542, new City(2542, "San Nicol s de los Garza", "MEX",
				495540));
		cities.put(2543, new City(2543, "Durango", "MEX", 490524));
		cities.put(2544, new City(2544, "Chimalhuac n", "MEX", 490245));
		cities.put(2545, new City(2545, "Tlaquepaque", "MEX", 475472));
		cities.put(2546, new City(2546, "Atizap n de Zaragoza", "MEX",
				467262));
		cities.put(2547, new City(2547, "Veracruz", "MEX", 457119));
		cities.put(2548, new City(2548, "Cuautitl n Izcalli", "MEX", 452976));
		cities.put(2549, new City(2549, "Irapuato", "MEX", 440039));
		cities.put(2550,
				new City(2550, "Tuxtla Guti‚rrez", "MEX", 433544));
		cities.put(2551, new City(2551, "Tultitl n", "MEX", 432411));
		cities.put(2552, new City(2552, "Reynosa", "MEX", 419776));
		cities.put(2553, new City(2553, "Benito Ju rez", "MEX", 419276));
		...
		cities.put(2557, new City(2557, "Mazatl n", "MEX", 380265));
		...
		cities.put(2562, new City(2562, "Tonal ", "MEX", 336109));
		...
		cities.put(2570, new City(2570, "G¢mez Palacio", "MEX", 272806));
		cities.put(2571, new City(2571, "Tapachula", "MEX", 271141));
		cities.put(2572, new City(2572, "Nicol s Romero", "MEX", 269393));
		...
		cities.put(2576, new City(2576, "Oaxaca de Ju rez", "MEX", 256848));
		cities.put(2577, new City(2577, "Coacalco de Berrioz bal", "MEX",
				252270));
		...
		cities.put(2582, new City(2582, "Tehuac n", "MEX", 225943));
		cities.put(2583, new City(2583, "Chalco", "MEX", 222201));
		cities.put(2584, new City(2584, "C rdenas", "MEX", 216903));
		cities.put(2585, new City(2585, "Campeche", "MEX", 216735));
		cities.put(2586, new City(2586, "La Paz", "MEX", 213045));
		cities.put(2587, new City(2587, "Oth¢n P. Blanco (Chetumal)", "MEX",
				208014));
		...
		cities.put(2597, new City(2597, "Soledad de Graciano S nchez",
				"MEX", 179956));
		cities.put(2598, new City(2598, "San Juan del R¡o", "MEX", 179300));
		cities.put(2599, new City(2599, "San Felipe del Progreso", "MEX",
				177330));
		cities.put(2600, new City(2600, "C¢rdoba", "MEX", 176952));
		cities.put(2601, new City(2601, "Tec mac", "MEX", 172410));
		cities.put(2602, new City(2602, "Ocosingo", "MEX", 171495));
		cities.put(2603, new City(2603, "Carmen", "MEX", 171367));
		cities.put(2604, new City(2604, "L zaro C rdenas", "MEX", 170878));
		...
		cities.put(2612, new City(2612, "Minatitl n", "MEX", 152983));
		...
		cities.put(2616, new City(2616, "San Luis R¡o Colorado", "MEX",
				145276));
		cities.put(2617, new City(2617, "P‚njamo", "MEX", 143927));
		cities.put(2618, new City(2618, "San Andr‚s Tuxtla", "MEX",
				142251));
		cities.put(2619, new City(2619, "Guanajuato", "MEX", 141215));
		cities.put(2620, new City(2620, "Navojoa", "MEX", 140495));
		cities.put(2621, new City(2621, "Zit cuaro", "MEX", 137970));
		cities.put(2622, new City(2622, "Boca del R¡o", "MEX", 135721));
		...
		cities.put(2626, new City(2626, "San Juan Bautista Tuxtepec", "MEX",
				133675));
		cities.put(2627, new City(2627, "San Crist¢bal de las Casas", "MEX",
				132317));
		...
		cities.put(2635, new City(2635, "T£xpam", "MEX", 126475));
		cities.put(2636, new City(2636, "San Pedro Garza Garc¡a", "MEX",
				126147));
		cities.put(2637, new City(2637, "Cuauht‚moc", "MEX", 124279));
		...
		cities.put(2641, new City(2641, "Tlajomulco de Z£¤iga", "MEX",
				123220));
		cities.put(2642, new City(2642, "Tulancingo de Bravo", "MEX", 121946));
		cities.put(2643, new City(2643, "Zinacantepec", "MEX", 121715));
		cities.put(2644, new City(2644, "San Mart¡n Texmelucan", "MEX",
				121093));
		cities.put(2645, new City(2645, "Tepatitl n de Morelos", "MEX",
				118948));
		cities.put(2646, new City(2646, "Mart¡nez de la Torre", "MEX",
				118815));
		cities.put(2647, new City(2647, "Orizaba", "MEX", 118488));
		cities.put(2648, new City(2648, "Apatzing n", "MEX", 117849));
		...
		cities.put(2654, new City(2654, "Almoloya de Ju rez", "MEX", 110550));
		cities.put(2655, new City(2655, "Ac mbaro", "MEX", 110487));
		cities.put(2656, new City(2656, "Acu¤a", "MEX", 110388));
		...
		cities.put(2661, new City(2661, "Comit n de Dom¡nguez", "MEX",
				104986));
		cities.put(2662, new City(2662, "Cunduac n", "MEX", 104164));
		cities.put(2663, new City(2663, "R¡o Bravo", "MEX", 103901));
		...
		cities.put(2667, new City(2667, "San Francisco del Rinc¢n", "MEX",
				100149));
		cities.put(2668, new City(2668, "Taxco de Alarc¢n", "MEX", 99907));
		...
		cities.put(2672, new City(2672, "Tecom n", "MEX", 99296));
		...
		cities.put(2676, new City(2676, "Jos‚ Azueta", "MEX", 95448));
		...
		cities.put(2685, new City(2685, "P nuco", "MEX", 90551));
		...
		cities.put(2693, new City(2693, "Bender (TŒghina)", "MDA", 125700));
		...
		cities.put(2703, new City(2703, "Na‡ala-Porto", "MOZ", 158248));
		...
		cities.put(2735, new City(2735, "Le¢n", "NIC", 123865));
		...
		cities.put(2811, new City(2811, "B‘rum", "NOR", 101340));
		cities.put(2812, new City(2812, "Abidjan", "CIV", 2500000));
		cities.put(2813, new City(2813, "Bouak‚", "CIV", 329850));
		...
		cities.put(2905, new City(2905, "Hu nuco", "PER", 129688));
		...
		cities.put(2917, new City(2917, "Co¡mbra", "PRT", 96100));
		cities.put(2918, new City(2918, "Braga", "PRT", 90535));
		cities.put(2919, new City(2919, "San Juan", "PRI", 434374));
		cities.put(2920, new City(2920, "Bayam¢n", "PRI", 224044));
		...
		cities.put(2926, new City(2926, "Mayag�?ez", "PRI", 98434));
		cities.put(2927, new City(2927, "Toa Baja", "PRI", 94085));
		cities.put(2928, new City(2928, "Warszawa", "POL", 1615369));
		cities.put(2929, new City(2929, "L¢dz", "POL", 800110));
		cities.put(2930, new City(2930, "Krak¢w", "POL", 738150));
		...
		cities.put(2950, new City(2950, "Rzesz¢w", "POL", 162049));
		...
		cities.put(2955, new City(2955, "Dabrowa G¢rnicza", "POL", 131037));
		...
		cities.put(2959,
				new City(2959, "Gorz¢w Wielkopolski", "POL", 126019));
		cities.put(2960, new City(2960, "Wloclawek", "POL", 123373));
		cities.put(2961, new City(2961, "Chorz¢w", "POL", 121708));
		cities.put(2962, new City(2962, "Tarn¢w", "POL", 121494));
		cities.put(2963, new City(2963, "Zielona G¢ra", "POL", 118182));
		...
		cities.put(2969, new City(2969, "Jastrzebie-Zdr¢j", "POL", 102294));
		cities.put(2970, new City(2970, "Jaworzno", "POL", 97929));
		cities.put(2971, new City(2971, "Jelenia G¢ra", "POL", 93901));
		...
		cities.put(2987, new City(2987, "St-�?tienne", "FRA", 180210));
		...
		cities.put(2998, new City(2998, "NŒmes", "FRA", 133424));
	...
	public void createCities3000() {
		...
		cities.put(3002, new City(3002, "Besan‡on", "FRA", 117733));
		cities.put(3003, new City(3003, "Caen", "FRA", 113987));
		cities.put(3004, new City(3004, "Orl‚ans", "FRA", 113126));
		...
		cities.put(3033, new City(3033, "Tƒrgu Mures", "ROM", 165153));
		...
		cities.put(3049, new City(3049, "Gothenburg [G�?teborg]", "SWE",
				466990));
		cities.put(3050, new City(3050, "Malm�?", "SWE", 259579));
		cities.put(3051, new City(3051, "Uppsala", "SWE", 189569));
		cities.put(3052, new City(3052, "Link�?ping", "SWE", 133168));
		cities.put(3053, new City(3053, "V„ster†s", "SWE", 126328));
		cities.put(3054, new City(3054, "™rebro", "SWE", 124207));
		cities.put(3055, new City(3055, "Norrk�?ping", "SWE", 122199));
		cities.put(3056, new City(3056, "Helsingborg", "SWE", 117737));
		cities.put(3057, new City(3057, "J�?nk�?ping", "SWE",
				117095));
		cities.put(3058, new City(3058, "Ume†", "SWE", 104512));
		cities.put(3059, new City(3059, "Lund", "SWE", 98948));
		cities.put(3060, new City(3060, "Bor†s", "SWE", 96883));
		cities.put(3061, new City(3061, "Sundsvall", "SWE", 93126));
		cities.put(3062, new City(3062, "G„vle", "SWE", 90742));
		...
		cities.put(3070, new City(3070, "Munich [M�?nchen]", "DEU", 1194560));
		cities.put(3071, new City(3071, "K�?ln", "DEU", 962507));
		...
		cities.put(3076, new City(3076, "D�?sseldorf", "DEU", 568855));
		...
		cities.put(3081, new City(3081, "N�?rnberg", "DEU", 486628));
		...
		cities.put(3091, new City(3091, "M�?nster", "DEU", 264670));
		cities.put(3092,
				new City(3092, "M�?nchengladbach", "DEU", 263697));
		...
		cities.put(3102, new City(3102, "L�?beck", "DEU", 213326));
		...
		cities.put(3108, new City(3108, "Saarbr�?cken", "DEU", 183836));
		...
		cities.put(3112, new City(3112, "M�?lheim an der Ruhr", "DEU",
				173895));
		cities.put(3113, new City(3113, "Solingen", "DEU", 165583));
		cities.put(3114, new City(3114, "Osnabr�?ck", "DEU", 164539));
		...
		cities.put(3140, new City(3140, "F�?rth", "DEU", 109771));
		...
		cities.put(3154, new City(3154, "G�?tersloh", "DEU", 95028));
		cities.put(3155, new City(3155, "Marl", "DEU", 93735));
		cities.put(3156, new City(3156, "L�?nen", "DEU", 92044));
		cities.put(3157, new City(3157, "D�?ren", "DEU", 91092));
		...
		cities.put(3172, new City(3172, "SÆo Tom‚", "STP", 49541));
		...
		cities.put(3192, new City(3192, "Araïar", "SAU", 108100));
		...
		cities.put(3199, new City(3199, "ThiŠs", "SEN", 248000));
		...
		cities.put(3240, new City(3240, "Turku [�?bo]", "FIN", 172561));
		...
		cities.put(3245, new City(3245, "Z�?rich", "CHE", 336800));
		...
		cities.put(3315, new City(3315, "K›benhavn", "DNK", 495699));
		cities.put(3316, new City(3316, "�?rhus", "DNK", 284846));
		...
		cities.put(3345, new City(3345, "Cesk‚ Budejovice", "CZE", 98186));
		cities.put(3346,
				new City(3346, "Hradec Kr lov‚", "CZE", 98080));
		cities.put(3347, new City(3347, "ést¡ nad Labem", "CZE", 95491));
		...
		cities.put(3356, new City(3356, "GabŠs", "TUN", 106600));
		...
		cities.put(3364, new City(3364, "Mersin (I‡el)", "TUR", 587212));
		...
		cities.put(3378, new City(3378, "Elƒzig", "TUR", 228815));
		...
		cities.put(3388, new City(3388, "€orum", "TUR", 145495));
		cities.put(3389, new City(3389, "K�?tahya", "TUR", 144761));
		...
		cities.put(3398, new City(3398, "€orlu", "TUR", 123300));
		cities.put(3399, new City(3399, "Isparta", "TUR", 121911));
		cities.put(3400, new City(3400, "Karab�?k", "TUR", 118285));
		...
		cities.put(3487, new City(3487, "P‚cs", "HUN", 157332));
		cities.put(3488, new City(3488, "Gy�?r", "HUN", 127119));
		cities.put(3489, new City(3489, "Nyiregyh za", "HUN", 112419));
		cities.put(3490, new City(3490, "Kecskem‚t", "HUN", 105606));
		cities.put(3491, new City(3491, "Sz‚kesfeh‚rv r", "HUN",
				105119));
		cities.put(3492, new City(3492, "Montevideo", "URY", 1236000));
		cities.put(3493, new City(3493, "Noum‚a", "NCL", 76293));
		...
		cities.put(3510, new City(3510, "K�?kon", "UZB", 190100));
		...
		cities.put(3514, new City(3514, "šrgenc", "UZB", 138900));
		...
		cities.put(3538, new City(3538, "Citt… del Vaticano", "VAT", 455));
		cities.put(3539, new City(3539, "Caracas", "VEN", 1975294));
		cities.put(3540, new City(3540, "Maraca¡bo", "VEN", 1304776));
		...
		cities.put(3547, new City(3547, "Matur¡n", "VEN", 319726));
		cities.put(3548, new City(3548, "San Crist¢bal", "VEN", 319373));
		cities.put(3549, new City(3549, "Ciudad Bol¡var", "VEN", 301107));
		cities.put(3550, new City(3550, "Cuman ", "VEN", 293105));
		cities.put(3551, new City(3551, "M‚rida", "VEN", 224887));
		...
		cities.put(3567, new City(3567, "Car£pano", "VEN", 119639));
		...
		cities.put(3579, new City(3579, "El Lim¢n", "VEN", 90000));
	...
	public void createCities3600() {
		...
		cities.put(3773, new City(3773, "Biˆn Hoa", "VNM", 282095));
		...
		cities.put(3785, new City(3785, "Phan Thiˆt", "VNM", 114236));
	...
	public void createCountries() {
		...
		countries.put("CIV", new Country("CIV", "C“te d?Ivoire",
		...
		countries.put("REU", new Country("REU", "R‚union", "Africa",
